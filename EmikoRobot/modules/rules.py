...
def send_rules(update, chat_id, from_pm=False):
    ...
    text = f"*{escape_markdown(chat.title)}* Rules te chu:\n\n{rules}"
    ...
    if from_pm and rules:
        ...
        bot.send_message(
            user.id,
            "Group admin ten rules an set lo. "
            "Chumi avang chuan a zalen tihna anilo...!",
        )
    elif rules and reply_msg:
        reply_msg.reply_text(
            "A hnuai a Rules tih khu hmet rawh.",
...
def set_rules(update: Update, context: CallbackContext):
    ...
    if len(args) == 2:
        ...
        update.effective_message.reply_text("He Group rules tur hi set fel ani ta e.")
...
def clear_rules(update: Update, context: CallbackContext):
    ...
    update.effective_message.reply_text("He Group Ruleshi clear ani!")
